...
try:
        ...
        for face_encoding in face_encodings:
            ...
            if distance < confidence_threshold:
                ...
                if last_recognition_time is None or (now - last_recognition_time) >= entry_duration:
                    ...
                    screenshot_filename = f"screenshots/Dinesh Datta_{now.strftime('%Y-%m-%d_%H-%M-%S')}.jpg"
    ...
    if not df.empty:
        df.to_excel('excel_sc_dt.xlsx', index=False)
        print("Attendance and screenshots saved to 'excel_sc_dt.xlsx'.")
